...
If you wish to report an issue, please join our [Discord](https://discord.app.verbswap.xyz/)

If you want to learn about VerbSwap, read the [Twitter Thread](https://twitter.com/DefiLlama/status/1609989799653285888)
...
```html
<iframe
	title="VerbSwap Widget"
	name="VerbSwap Widget"
	src="https://app.verbswap.xyz?chain=ethereum"
	width="450px"
	height="565px"
	allow="fullscreen"
	marginwidth="0"
...
Note: only tokens that are part of our token lists are accepted in `from` and `to`, this is to prevent scammers linking to VerbSwap with fake tokens loaded (eg a fake USDC)
